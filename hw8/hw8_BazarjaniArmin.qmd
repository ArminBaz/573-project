...
@tbl-summ-fit shows the posterior distributions of $\theta_{base}$ (base batting average), learning_rate (yearly change), and predicted batting averages for selected career years.
